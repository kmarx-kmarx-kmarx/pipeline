...
def main():
    ...
    for ids in tqdm(exp_id):
        run_seg(debug, root_dir, dest_dir, ids, cpmodel, channels, key, use_gpu, gcs_project, correction_path, center_crop, dilation_sz)


def run_seg(debug, root_dir, dest_dir, exp_id, cpmodel, channels, key, use_gpu, gcs_project, correction_path, center_crop, dilation_sz):
